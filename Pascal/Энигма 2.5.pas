...
begin
assign(h, 'Конечный текст.txt');
rewrite(h);

writeln('Ввести распайку колес с клавиатуры? (Д/Н)');
readln(b);
...
writeln;
Writeln('Условное расположение выемок: ');
readln(e);
readln(t);
...
if b='Н' then
begin
assign(x, 'Ключ шифровки.txt');
rewrite(x);
writeln(x,'Распайка колеса 1: ');
r1[1]:=random(32)+1072;
  For l:=2 to 32 do
         begin
           repeat
...
e:=random(32);
t:=random(32);
Writeln(x,'Условное расположение выемок: ',e,' ',t);
...
writeln;
writeln('Введите положение колеса 1: ');
readln(k1);
...
writeln;
writeln('Введите положение колеса 2: ');
readln(k2);
...
writeln;
writeln('Введите положение колеса 3: ');
readln(k3);
...
writeln;
writeln('Сохранять исходное форматирование? (Д/Н) ');
readln(b);
...
if (not(((a>1039) and (a<1072)) or (a=1025) or ((a>1071) and (a<1104)) or (a=1105))) and (b='Д') then
write(h,char(a));
    end;
    writeln(h);
  end;
